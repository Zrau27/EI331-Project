...
# Form implementation generated from reading ui file 'D:\sigtem\ui_v3\func6_5.ui'
#
...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "滤波"))
        self.label_6.setText(_translate("Form", "滤波"))
        self.label_2.setText(_translate("Form", "          滤波信号 xp(t)                        h(t)=T*sin(wc*t)/(πt)"))
        self.label_3.setText(_translate("Form", "截止频率 wc"))
        self.label_4.setText(_translate("Form", "增益T"))
        self.label_7.setText(_translate("Form", "经滤波信号     xr(t)=xp(t)*h(t)"))
