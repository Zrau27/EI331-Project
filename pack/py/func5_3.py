...
# Form implementation generated from reading ui file 'D:\sigtem\ui_v3\func5_3.ui'
#
...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "离散周期信号傅里叶级数"))
        self.label_6.setText(_translate("Form", "离散周期信号傅里叶级数"))
        self.label.setText(_translate("Form", "连续周期函数 x[n] = "))
        self.label_4.setText(_translate("Form", " 周期 N"))
