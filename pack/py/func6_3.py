...
# Form implementation generated from reading ui file 'D:\sigtem\ui_v3\func6_3.ui'
#
...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "采样"))
        self.label_6.setText(_translate("Form", "采样"))
        self.label_2.setText(_translate("Form", "采样信号 r(t)"))
        self.label_3.setText(_translate("Form", "采样函数 p(t)=Σδ(t-nT)"))
        self.label_4.setText(_translate("Form", "采样频率 ws"))
        self.label_7.setText(_translate("Form", "经采样信号                    xp(t)=r(t)p(t)"))
