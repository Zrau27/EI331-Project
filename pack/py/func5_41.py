...
# Form implementation generated from reading ui file 'D:\sigtem\ui_v3\func5_41.ui'
#
...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "连续周期方波信号"))
        self.label.setText(_translate("Form", "连续周期方波信号"))
        self.label_3.setText(_translate("Form", "大周期T"))
        self.label_4.setText(_translate("Form", "小周期T0"))
