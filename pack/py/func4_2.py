...
# Form implementation generated from reading ui file 'D:\sigtem\ui_v3\func4_2.ui'
#
...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "连续矩形信号"))
        self.label.setText(_translate("Form", "连续矩形信号"))
        self.label_2.setText(_translate("Form", "x = u(t+t0) - u(t-t0)"))
        self.label_3.setText(_translate("Form", "t0"))
