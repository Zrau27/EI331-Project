...
# Form implementation generated from reading ui file 'D:\sigtem\ui_v3\func2_23.ui'
#
...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "连续复指数指数函数"))
        self.label.setText(_translate("Form", "连续复指数指数函数"))
        self.label_2.setText(_translate("Form", "   x = k*e^[(a+bj)t+s)]"))
